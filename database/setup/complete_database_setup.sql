-- Complete Database Setup for HR3 System
...
-- Create users table with employee information
...
-- Remove separate employees table - using users table instead
...
-- Create shift_types table if not exists
...
-- Create shift_requests table if not exists
...
-- Create leave_types table if not exists
...
-- Create claim_types table if not exists
...
-- Insert sample employee users if not exists
INSERT IGNORE INTO users (name, email, password, employee_number, first_name, last_name, phone, position, department, hire_date, salary, status) VALUES
('John Anderson', 'john.anderson@jetlouge.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'EMP001', 'John', 'Anderson', '+1-555-0123', 'HR Administrator', 'Human Resources', '2023-01-15', 65000.00, 'active'),
('Jane Smith', 'jane.smith@jetlouge.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'EMP002', 'Jane', 'Smith', '+1-555-0124', 'Software Developer', 'IT', '2023-03-20', 75000.00, 'active'),
('Mike Johnson', 'mike.johnson@jetlouge.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'EMP003', 'Mike', 'Johnson', '+1-555-0125', 'Marketing Manager', 'Marketing', '2023-02-10', 70000.00, 'active'),
('Sarah Wilson', 'sarah.wilson@jetlouge.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'EMP004', 'Sarah', 'Wilson', '+1-555-0126', 'Accountant', 'Finance', '2023-04-05', 60000.00, 'active'),
('David Brown', 'david.brown@jetlouge.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'EMP005', 'David', 'Brown', '+1-555-0127', 'Sales Representative', 'Sales', '2023-05-12', 55000.00, 'active');

-- Insert sample shift types if not exists
INSERT IGNORE INTO shift_types (name, type, start_time, end_time, break_duration, color_code, description) VALUES
...
-- Insert sample leave types if not exists
INSERT IGNORE INTO leave_types (name, code, max_days_per_year, carry_forward, requires_approval, is_active, description) VALUES
...
-- Insert sample claim types if not exists
INSERT IGNORE INTO claim_types (name, code, max_amount, requires_receipt, requires_approval, is_active, description) VALUES
...
-- Insert sample leave balances for current year if not exists
INSERT IGNORE INTO leave_balances (employee_id, leave_type_id, year, allocated_days, used_days, carried_forward) VALUES
...
-- Insert sample time entries if not exists
INSERT IGNORE INTO time_entries (employee_id, work_date, clock_in_time, clock_out_time, hours_worked, overtime_hours, description, status) VALUES
...
-- Insert sample shifts for current week if not exists
INSERT IGNORE INTO shifts (employee_id, shift_type_id, date, start_time, end_time, status, notes) VALUES
...
-- Insert sample leave requests if not exists
INSERT IGNORE INTO leave_requests (employee_id, leave_type_id, start_date, end_date, days_requested, reason, status) VALUES
...
-- Insert sample claims if not exists
INSERT IGNORE INTO claims (employee_id, claim_type_id, amount, submitted_date, description, status) VALUES
